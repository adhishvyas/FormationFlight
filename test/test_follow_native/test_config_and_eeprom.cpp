...
static const ConfigCase kConfigCases[] = {
    ...
    {"autothrottleEnableRcChannel=16 passes", [](FollowRuntimeConfig &c) { c.autothrottleEnableRcChannel = 16; }, true},
    {"maxTargetSpeedMps==minTargetSpeedMps fails", [](FollowRuntimeConfig &c) { c.minTargetSpeedMps = 10; c.maxTargetSpeedMps = 10; }, false},
    {"minTargetSpeedMps=-1 fails",     [](FollowRuntimeConfig &c) { c.minTargetSpeedMps = -1; },     false},
    {"maxTargetSpeedMps>minTargetSpeedMps passes", [](FollowRuntimeConfig &c) { c.minTargetSpeedMps = 10; c.maxTargetSpeedMps = 10.1; }, true},
